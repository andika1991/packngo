            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Vendor penyedia Tiket Bus</h1>
                        <a href="csvvendorbus.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Download CSV Vendor</a>
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="tambahvendorbus.php" enctype="multipart/form-data">
    ...
    <tbody>
        ...
        $query = "SELECT * FROM vendor_bus";
        $result = mysqli_query($conn, $query);

        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                echo "<td>" . $row["id_vendorbus"] . "</td>";
                ...
                echo "<td>
                <button class='btn btn-primary btn-sm edit-btn' data-id='" . $row["id_vendorbus"] . "'  data-nama='" . $row["nama_vendor"] . "'  data-alamat='" . $row["alamat_vendor"] . "'  data-logo='" . $row["logo_vendor"] . "'  data-toggle='modal'  data-target='#editModal'>Edit</button>
                <button class='btn btn-danger btn-sm delete-btn' data-id='" . $row["id_vendorbus"] . "' data-toggle='modal' data-target='#deleteModal'>Delete</button>
                      </td>";
                echo "</tr>";
            }
        } else {
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Hapus Data Vendor Bus</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.delete-btn').click(function() {
            ...
            $('#deleteVendorBtn').attr('href', 'hapusvendorbus.php?id=' + vendorId);
        });
    });
</script>
