        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="tambahjadwalbus.php" class="btn btn-primary">Tambah Data</a>
...
<table class="table">
    ...
    <tbody>
        ...
        $updateQuery = "UPDATE jadwal_tiket_bus SET status_jadwal = 'On Going' WHERE waktu_keberangkatan <= NOW()";
        mysqli_query($conn, $updateQuery);
        
        // Menandai jadwal tiket yang sudah tiba
        $updateQuery = "UPDATE jadwal_tiket_bus SET status_jadwal = 'Arrived' WHERE waktu_kedatangan <= NOW()";
        mysqli_query($conn, $updateQuery);
        ...
        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                echo "<td>" . $row["id_jadwaltiketbus"] . "</td>";
...
<table class="table">
    ...
    <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<tr><td colspan='12'>Tidak ada jadwal tiket pesawat yang tersedia.</td></tr>";
        }
        ?>
    </tbody>
</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah Anda yakin ingin menghapus jadwal tiket bus ini?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
        <form action="hapusjadwalbus.php" method="POST">
          <input type="hidden" id="deleteId" name="id_jadwaltiketbus">
...
<script>
  $(document).ready(function() {
    $('.delete-btn').click(function() {
      var id = $(this).data('id_jadwaltiketbus');
      $('#deleteId').val(id);
    });
  });
</script>
