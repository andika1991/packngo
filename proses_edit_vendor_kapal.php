...
if (!empty($newLogo['name'])) {
    ...
    $query_select = "SELECT logo_vendor FROM vendor_kapal WHERE id_vendor = $id";
...
$query = "UPDATE vendor_kapal SET nama_vendor='$namaVendor', alamat_vendor='$alamatVendor', logo_vendor='$logoVendor' WHERE id_vendor=$id";
