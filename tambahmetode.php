...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tambah Metode Pembayaran</h1>
<p class="mb-4">Isi formulir di bawah ini untuk menambahkan metode pembayaran baru.</p>

<!-- Form Tambah Metode Pembayaran -->
<form method="POST" action="proses_tambah_metode_pembayaran.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nomor_metode" name="nomor_metode" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="deksripsi_metode">Deskripsi Metode:</label>
        <textarea class="form-control" id="deksripsi_metode" name="deksripsi_metode" rows="8" cols="50" required></textarea>

    </div>
    <div class="form-group">
        <label for="logo_metode">Logo Metode:</label>
        <input type="file" class="form-control-file" id="logo_metode" name="logo_metode" required>
    </div>
