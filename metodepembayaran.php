    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <!-- Table Pengguna -->
   <!-- Tambah Data Button -->
   <a href="tambahmetode.php" class="btn btn-primary">Tambah Data</a>
    ...
    <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><img src='" . $row["logo_metode"] . "' alt='Logo metode' style='max-width: 100px; max-height: 100px;'></td>";
                echo "<td>
                    <a href='editmetode.php?id=" . $row["id_metode"] . "' class='btn btn-primary btn-sm edit-btn'>Edit</a>
                    <button class='btn btn-danger btn-sm delete-btn' data-id='" . $row["id_metode"] . "' data-toggle='modal' data-target='#deleteModal'>Delete</button>
                </td>";
                echo "</tr>";
            }
        } else {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Hapus Data Metode Pembayaran</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus data metode pembayaran ini?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <a id="deleteMetodeBtn" class="btn btn-danger" href="#">Hapus</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('.delete-btn').click(function() {
            var id_metode = $(this).data('id');
            $('#deleteMetodeBtn').attr('href', 'hapusmetodepembayaran.php?id=' + id_metode);
        });
    });
</script>
